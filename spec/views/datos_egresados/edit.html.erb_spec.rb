...
RSpec.describe "datos_egresados/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit datos_egresado form" do
    render

    assert_select "form[action=?][method=?]", datos_egresado_path(@datos_egresado), "post" do
