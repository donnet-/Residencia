...
RSpec.describe "banco_proyectos/new", type: :view do
  before(:each) do
    assign(:banco_proyecto, BancoProyecto.new(
  ...
  it "renders new banco_proyecto form" do
    render

    assert_select "form[action=?][method=?]", banco_proyectos_path, "post" do
